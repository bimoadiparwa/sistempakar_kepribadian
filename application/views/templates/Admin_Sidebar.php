    ...
    <div class="col-md-3 left_col">
      <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
          <a href="<?= base_url('admin'); ?>" class="site_title"><i class="fa fa-desktop"></i> <span>SP-Kepribadian</span></a>
        </div>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
          <div class="menu_section">
            <ul class="nav side-menu">
              ...
              <li><a href="<?= base_url('ciri'); ?>"><i class="fa fa-fw fa-edit"></i> Ciri-Ciri</a></li>
              <li><a href="<?= base_url('kepribadian'); ?>"><i class="fa fa-fw fa-desktop"></i>Kepribadian</a></li>
