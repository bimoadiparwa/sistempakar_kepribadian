                  ...
                  <table id="datatable-buttons" class="table table-striped table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th style="text-align: center;">Nama Kepribadian</th>
                        <th style="text-align: center;">Nama Ciri-Ciri</th>
                    ...
                    <tbody>
                      ...
                      <?php foreach ($pengetahuan as $P) : ?>
                        <tr>
                          ...
                          <td><?= $P['kode_kepribadian']; ?> - <?= $P['nama_kepribadian']; ?></td>
                          <td><?= $P['kode_ciri']; ?> - <?= $P['nama_ciri']; ?></td>
